...
public class ModEvents {
    ...
    public static void equipTunic(LivingEquipmentChangeEvent event)
    {
        if (event.getEntity() instanceof Player player)
        {
            ...
            ItemStack TunicLegs = new ItemStack(TunicLegsItem);

            Item TunicItem = ItemRegistry.tunic.get();
            ItemStack Tunic = new ItemStack(TunicItem);

            if (event.getTo() == Tunic) {
                ...
                player.setItemSlot(EquipmentSlot.LEGS, TunicLegs);
            }
            else if (player.hasItemInSlot(EquipmentSlot.LEGS) && player.getItemBySlot(EquipmentSlot.LEGS).equals(TunicLegs))
            {
    ...
    public static void equipLorica(LivingEquipmentChangeEvent event)
    {
        if (event.getEntity() instanceof Player) {
            ...
            else if (player.getItemBySlot(EquipmentSlot.CHEST) == new ItemStack(LoricaSegmentata) && player.getItemBySlot(EquipmentSlot.LEGS) == new ItemStack(LoricaSegmentata))
            {
