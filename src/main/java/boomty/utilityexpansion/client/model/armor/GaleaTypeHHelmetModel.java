...
public class GaleaTypeHHelmetModel extends AnimatedGeoModel<Galea> {
    ...
    public ResourceLocation getModelLocation(Galea object) {
        return new ResourceLocation(UtilityExpansion.MOD_ID, "geo/galea_type_h_3.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(Galea object) {
        return new ResourceLocation(UtilityExpansion.MOD_ID, "textures/item/galea_type_h_texture.png");
    }
